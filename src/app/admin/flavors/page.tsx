...
import { addFlavor, deleteFlavor } from "./actions";
    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-[2fr,1fr]">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
          ...
          <form action={addFlavor} className="mt-3 space-y-3">
            ...
            <button
              type="submit"
              className="inline-flex items-center rounded-md bg-zinc-900 px-3 py-2 text-sm font-semibold text-white hover:bg-zinc-800"
            >
              Add flavor
            </button>
          </form>
